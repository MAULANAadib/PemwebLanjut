...
book_bp.route('/api/books/<int:id>', methods=['GET'])(get_book)

#Routes for a new book (POST)
book_bp.route('/api/books', methods=['POST'])(add_book)

#Routes for Update a book (PUT)
book_bp.route('/api/books/<int:id>', methods=['PUT'])(update_book)

#Routes for Partially update a book (PATCH)
book_bp.route('/api/books/<int:id>', methods=['PATCH'])(patch_book)

#Routes fo Delete a book (DELETE)
book_bp.route('/api/books/<int:id>', methods=['DELETE'])(delete_book)
